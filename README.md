...
Rustique works like many Operating System package managers such as Portage and Apt: first you `sync` a local copy of the package information, and then you can `install`, `remove`, and `update` mods. Dependencies are also handled automatically.
...
| `./Rustique -h sync`                              | Show the more info about the command specified. Replace sync with any of the other commands                                                                                                                               |
