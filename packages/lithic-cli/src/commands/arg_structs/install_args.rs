...
pub struct InstallArgs {
   /// List all the mods you want to install with a space between each mod. Example ./Lithic install alchemy combatoverhaul
   #[arg(num_args = 1..)]
   pub(crate) mod_ids: Vec<String>,

   /// Setting this flag will prevent Lithic from installing dependencies discovered during installation
