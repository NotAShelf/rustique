...
use lithic_core::config::structs::ListColumn;
...
pub struct ListArgs {
   ...
   /// (Does not work with modpack commands) List all game versions for MAJOR.MINOR: Example, Lithic list --game-versions 1.20, which will show all valid versions for 1.20.x, --game-versions 1 will show all versions 1.x.x
