...
use lithic_core::config::structs::{CellAttr, CellColor, ListColumn, SearchColumn};
...
pub enum TableSubCommands {
    ...
    ///
    /// Reset a table back to the Lithic defaults
    ///
...
pub enum TableArgsSubCommands {
    ...
    ///
    /// ./Lithic config table set list --headers --fields name,mod_id,version --color green --attr bold
    ///
    ...
    ///
    /// ./Lithic config table set search --headers --fields name,mod-id,last-released --color blue --attr bold
    ///
